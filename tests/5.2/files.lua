...
print("cannot close standard files")
...
assert(not pcall(f))  -- read lines after EOF
print("copy from file to otherfile")
for l in io.lines(file) do io.write(l, "\n") end
io.close()
print("copy from otherfile back to file")
...
print("test errors in read/write")
do
...
print("test for multipe arguments in 'lines'")
...
print('le load3')
print("loading file with initial comment without end of line")
testloadfile("# a non-ending comment", nil)

print('le load4')

print("checking Unicode BOM in files")
...
print("checking line numbers in files with initial comments")
...
do
  ...
  assert(f() == t)
  local teste = {}
  f = assert(loadfile(file, 't', teste))
  assert(f() == teste)
