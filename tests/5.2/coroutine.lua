...
print(" tests for multiple yield/resume arguments")
...
print(" yielding across C boundaries")
...
print(" access to locals of collected corroutines")
...
print(" old bug: attempt to resume itself")
...
print(" attempt to resume 'normal' coroutine")
...
print(" infinite recursion of coroutines BROKEN")
--a = function(a) coroutine.wrap(a)(a) end
--assert(not pcall(a, a))


print(" access to locals of erroneous coroutines")
...
print(" overwrite previous position of local `a'")
...
print(" leaving a pending coroutine open")
...
print(" testing coroutines with C bodies")
f = T.makeCfunc([[
        pushnum 102
	yieldk	1 U2
	return 2
...
print(" testing chain of suspendable C calls")
...
a = {co()}
print(" three '34's (one from each pending C call)")
assert(#a == 3 and a[1] == a[2] and a[2] == a[3] and a[3] == 34)


print(" testing yields with continuations")
...
print(" arguments left from fist resume")
assert(a[7] == 3 and a[8] == 4)
print(" arguments to last resume")
assert(a[9] == 7 and a[10] == 8)
print(" error message and nothing more")
assert(a[11]:find("errmsg") and #a == 11)
print(" check arguments to pcallk")
