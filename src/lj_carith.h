...
LJ_FUNC uint64_t lj_carith_check64_raw(lua_State *L, cTValue *o, TValue *out, CTypeID *id);
LJ_FUNC int lj_carith_int64(lua_State *L, TValue *res, CTypeID id, uint64_t u0, uint64_t u1, MMS mm);
